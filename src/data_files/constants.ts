export const SITE = {
  title: "Biserica Credința",
  tagline: "Suntem o comunitate vie de creștini care Îl urmează pe Hristos.",
  description: "Biserica Credința - Suntem o comunitate vie de creștini care Îl urmează pe Hristos și caută să trăiască credința în mod autentic, prin dragoste față de Dumnezeu și față de semeni.",
  description_short: "Biserica Credința - Suntem o comunitate vie de creștini care Îl urmează pe Hristos.",
...
export const SEO = {
  ...
  structuredData: {
    ...
    address: {
      "@type": "PostalAddress",
      streetAddress: "Bulevardul Voluntari nr. 61A",
      addressLocality: "Voluntari",
      addressCountry: "RO"
    },
    contactPoint: {
      "@type": "ContactPoint",
      telephone: "+40788980747",
    ...
    hasPart: [
      ...
      {
        "@type": "WebPage",
        "@id": `${SITE.url}/past-projects`,
        url: `${SITE.url}/past-projects`,
        name: "Proiecte trecute",
        description: "Descoperă proiectele noastre.",
        isPartOf: {
          "@type": "Organization",
          "@id": SITE.url,
          url: SITE.url,
      ...
      },
      {
        ...
        name: "Contact",
        description: "Ai întrebări sau dorești să contribui cu ceva? Hai să facem o diferență împreună!",
        isPartOf: {
          "@type": "Organization",
          "@id": SITE.url,
          url: SITE.url,
  ...
  // Additional structured data for better sitelinks
  siteNavigationData: {
    "@context": "https://schema.org",
  ...
  breadcrumbData: {
    ...
    itemListElement: [
      ...
      },
      {
        ...
        position: 2,
        name: "Despre noi",
        item: `${SITE.url}/aboutUs`
      },
      {
        "@type": "ListItem",
        position: 3,
        name: "Proiecte trecute",
        item: `${SITE.url}/past-projects`
      },
      {
        "@type": "ListItem",
        position: 6,
...
export const OG = {
  ...
  type: "website",
  url: SITE.url,
  title: `${SITE.title}: Suntem o comunitate vie de creștini care Îl urmează pe Hristos.`,
  description: "Biserica Credința - Suntem o comunitate vie de creștini care Îl urmează pe Hristos și caută să trăiască credința în mod autentic, prin dragoste față de Dumnezeu și față de semeni.",
};

-- ========================================
-- POSTGRESQL QUERIES FOR POSTS TABLE
-- ========================================
...
-- ========================================
-- 2. POPULATE POSTS TABLE WITH SAMPLE DATA
-- ========================================

-- Insert project posts
INSERT INTO posts (
    title, content,created_at, keywords, post_type, category, 
    project_type, event_type, is_active, youtube_videos, cloudinary_ids, 
    gallery_flag, gallery_image_ids
) VALUES 
(
    ...
    '[]',
    TRUE,
	'["BIanca_Maxim_25.08.2025_txqnnz"]'
),
(
    'Ziua Dunării',
...
(
    'Proiect Viitor: Dezvoltarea Comunității prin Sport',
    'În următoarele luni, vom lansa un proiect ambițios de dezvoltare a comunității prin sport. Acest proiect va include programe de antrenament pentru tineri, workshop-uri educaționale și evenimente comunitare. Obiectivul nostru este să creăm un mediu în care fiecare membru al comunității să se poată dezvolta atât fizic, cât și mental.',
    'Lorem Ipsum',
    '2025-01-15 10:00:00',
    '["future", "community", "sports"]',
    '["viitor", "dezvoltare", "sport"]',
    'PROIECT',
    'project',
    'future',
    'ongoing',
...
-- Insert news posts
INSERT INTO posts (
    title, content, author, created_at, tags, keywords, post_type, category, url, read_button, gallery_flag, gallery_image_ids
) VALUES 
(
...
(
    'Puterea sportului și rolul antrenorilor în comunitate',
    'Biblioteca Județeană "Alexandru Odobescu" din Călărași a găzduit, în data de 26 martie 2024, o conferință despre puterea sportului și influența antrenorilor în comunitate. Antrenori și sportivi, care unesc și educă o comunitate prin astfel de activități, au fost prezenți la eveniment. Invitatul special al evenimentului a fost Mark Hull, antrenor, educator și lider internațional, care a influențat lumea sportivă.',
    'Lorem Ipsum',
    '2024-03-26 14:30:00',
    '["videoCarousel2", "leftPhotoCarousel2"]',
    '["sport", "educație", "lideri"]',
    'CONFERINTA',
    'news',
...
(
    'Călărășeanca Bianca Maxim, premiul I la Festivalul Internațional de Creație și Interpretare "Vocea Mării"',
    'Centrul Județean de Cultură și Creație (CJCC) Călărași anunță că, membra grupului vocal "Flores Campi", Bianca Maxim, a obținut Premiul I la Festivalul Internațional de Creație și Interpretare "Vocea Mării", secțiunea pop românesc.',
    'Lorem Ipsum',
    '2025-08-25 14:30:00',
    '["rightPhotoCarousel"]',
    '["muzică", "premiu", "festival"]',
    'MUZICA',
    'news',
    'https://opiniacalarasi.ro/calaraseanca-bianca-maxim-premiul-i-la-festivalul-international-de-creatie-si-interpretarevocea-marii/',
    TRUE,
    FALSE,
    '[]'
);

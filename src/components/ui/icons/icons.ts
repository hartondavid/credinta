export const Icons = {
  ...
  // New Material UI icons for values
  diversity3: {
    paths: [
      {
        d: "M16.5 13.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM12 13.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM7.5 13.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM12 7.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM7.5 7.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zM16.5 7.5c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2z",
      },
    ],
    class: "mt-1 h-8 w-8 shrink-0 fill-indigo-600 dark:fill-yellow-400",
    width: 24,
    height: 24,
    viewBox: "0 0 24 24",
    fill: "currentColor",
  ...
  handshake: {
    paths: [
      {
        d: "M20.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5zM17.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5zM14.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5zM11.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5zM8.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5zM5.5 12c0-.83-.67-1.5-1.5-1.5s-1.5.67-1.5 1.5.67 1.5 1.5 1.5 1.5-.67 1.5-1.5z",
      },
    ],
    class: "mt-1 h-8 w-8 shrink-0 fill-indigo-600 dark:fill-yellow-400",
    width: 24,
  ...
  anchor: {
    paths: [
      {
        d: "M17 15l1.55 1.55c-.96 1.69-3.33 3.04-5.55 3.37V11h3V9h-3V7.82C14.16 7.4 15 6.3 15 5c0-1.65-1.35-3-3-3S9 3.35 9 5c0 1.3.84 2.4 2 2.82V9H8v2h3v8.92c-2.22-.33-4.59-1.68-5.55-3.37L7 15H3l6 7 6-7h-4zM12 4c.55 0 1 .45 1 1s-.45 1-1 1-1-.45-1-1 .45-1 1-1z",
      },
    ],
    class: "mt-1 h-8 w-8 shrink-0 fill-indigo-600 dark:fill-yellow-400",
    width: 24,
  ...
  facebookFooter: {
    ...
    class: "size-4 shrink-0 fill-current text-black dark:text-white",
    viewBox: "0 0 24 24",
    stroke: "currentColor",
  },
  instagramFooter: {
  ...
  phone: {
    paths: [
      {
        d: "M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm0 18c-4.41 0-8-3.59-8-8s3.59-8 8-8 8 3.59 8 8-3.59 8-8 8zm1-13h-2v6H9v2h6v-2h2v-6zm-2 0v6h-2V7h2z",
      },
    ],
    class: "size-4 shrink-0 fill-current text-black dark:text-white",
    viewBox: "0 0 24 24",
